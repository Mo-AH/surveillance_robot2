...
bool markerCallback(surveillance_robot2::RoomInformation::Request &req, surveillance_robot2::RoomInformation::Response &res){
	surveillance_robot2::RoomConnection conn;
	switch (req.id){
	case 11:
		res.room = "E";
		res.x = 1.5;
...
{
	ros::init(argc, argv, "surveillance_robot2");
	ros::NodeHandle nh;
